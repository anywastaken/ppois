...
from social_network.community.PrivateChannelProfile import PrivateChannelProfile  # опционально
...
class PrivateChannel:
    def __init__(self, channel_id: int, name: str, description: str, owner_id: int):
        ...
        self.profile: PrivateChannelProfile = PrivateChannelProfile(channel_id)
